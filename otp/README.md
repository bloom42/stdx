...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/bloom42/stdx/otp)](https://pkg.go.dev/github.com/bloom42/stdx/otp) [![Build Status](https://travis-ci.org/pquerna/otp.svg?branch=master)](https://travis-ci.org/pquerna/otp)
...
Please [open issues in Github](https://github.com/bloom42/stdx/otp/issues) for ideas, bugs, and general thoughts.  Pull requests are of course preferred :)
