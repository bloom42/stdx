...
const (
	...
	CacheControl2Minute   = "public, max-age=120, must-revalidate"
	CacheControl5Minutes  = "public, max-age=300, must-revalidate"
	CacheControl10Minutes = "public, max-age=600, must-revalidate"
	CacheControl15Minutes = "public, max-age=900, must-revalidate"
	CacheControl30Minutes = "public, max-age=1800, must-revalidate"
	CacheControl1Hour     = "public, max-age=3600, must-revalidate"
	CacheControl1Day      = "public, max-age=86400, must-revalidate"
	CacheControl1Week     = "public, max-age=604800, must-revalidate"
	CacheControl1Month    = "public, max-age=2592000, must-revalidate"
